    ...
    <PageLayout>
      <div className="min-h-[80vh] flex items-center justify-center px-6 lg:px-24 py-24 bg-[#fdfdfd]">
        <div className="max-w-4xl text-center">
          ...
          <h1 className="tracking-[0.2em] text-[#111] uppercase mb-6">
            Nuestra filosofía
          </h1>
          
          <div className="w-12 h-[1px] bg-black/20 mx-auto mb-16" />

          <p className="text-body text-[14px] md:text-[15px] lg:text-[16px] leading-[2.2] text-[#444] mb-8 max-w-2xl mx-auto text-justify sm:text-center">
          ...
          <p className="text-body text-[14px] md:text-[15px] lg:text-[16px] leading-[2.2] text-[#444] max-w-2xl mx-auto text-justify sm:text-center">
